...
TOKEN(TK_CDECL, "__cdecl", TK_IS_KEYWORD)
TOKEN(TK_STDCALL, "__stdcall", TK_IS_KEYWORD)
TOKEN(TK_FASTCALL, "__fastcall", TK_IS_KEYWORD)
TOKEN(TK_INLINEASM, "__asm", TK_IS_KEYWORD | TK_IS_STATEMENT)
TOKEN(TK_ALIGNOF, "__alignof", TK_IS_KEYWORD | TK_IS_STATEMENT)
